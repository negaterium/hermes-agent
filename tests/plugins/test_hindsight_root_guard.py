...
def _exercise_root_guard(monkeypatch):
    # The shared test harness permits embedded daemons even as root; these
    # tests must instead exercise the production root-user guard.
