...
PLATFORM_HINTS = {
    "whatsapp": (
        ...
        "lines. "
        + _MEDIA_NATIVE +
        "Images (.jpg, .png, .webp) send as photos, videos (.mp4) play "
...
_PLATFORM_HINTS_NO_MEDIA = {
    ...
    "telegram": (
        "You are on Telegram. Standard Markdown auto-converts to Telegram formatting; "
        "the adapter ensures Standard Markdown is automatically converted. "
...
def _build_skills_system_prompt_inner(
    ...
    available_skill_entries = project_entries + visible_entries
